...
Clone the repository:
    ...
    https://github.com/zainabbehzad/Cash-Register.git
...
Explore the documentation: Once the HTML file is opened, you'll have access to the Cash-Register. Navigate through different sections using the sidebar navigation or scroll through the content to learn about various topics.
...
2: Clone the repository: Clone the repository to your local machine.
    ...
    git clone https://github.com/zainabbehzad/Cash-Register.git
